...
export default function DietMealCard({
    ...
    const mealTitle =
        meal.mealName === "breakfast"
            ? translations.diet.mealNames.breakfast
            : meal.mealName === "lunch"
                ? translations.diet.mealNames.lunch
                : translations.diet.mealNames.dinner;
    ...
    const handleAddIngredient = async () => {
        ...
        const newIngredient =
            `${translations.diet.ingredient.defaultName} ${meal.ingredients.length + 1}`;
                    ...
                    <View style={styles.ingredientsBox}>
                        ...
                        >
                            ...
                            <Text style={styles.addText}>
                                + {translations.diet.ingredient.add}
                            </Text>
