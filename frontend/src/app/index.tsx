...
export default function HomePage() {
  ...
  const activity: ActivityItem[] = [
    {
      id: 0,
      name: translations.home.activities.workout,
      icon: require('@/assets/icons/workout.png'),
      href: '/workout',
    },
    {
      id: 1,
      name: translations.home.activities.diet,
      ...
      >
        ...
        <View style={styles.activitySection}>
          ...
          <Pressable
            ...
            onPress={() => handleNavigate('/updating')}
          >
            <View style={styles.activityCardContent}>
              <View style={styles.activityIconContainer}>
                <Image
              ...
              <View style={styles.activityTitleContainer}>
                <Text style={styles.aiCoachTitle} numberOfLines={1}>
                  {translations.home.activities.aiCoach}
                </Text>
              </View>
            </View>
          </Pressable>
