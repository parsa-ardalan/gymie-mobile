            ...
            <View style={styles.card}>
                ...
                <View style={styles.badge}>
                    ...
                    <Text style={styles.badgeText}>
                        {translations.sleeping.title}
                    </Text>

                </View>

                <Text style={styles.infoText}>
                    {translations.sleeping.infoText}
                </Text>
                ...
                <View style={styles.row}>
                    ...
                    <View>
                        ...
                        <Text style={styles.label}>
                            {translations.sleeping.suggestedSleepTime}
                        </Text>
                    ...
                    <View style={styles.valueBox}>
                        ...
                        <Text style={styles.value}>
                            {suggestedSleepingHour} {translations.sleeping.hour}
                        </Text>
            ...
            <View style={styles.inputs}>
                ...
                <View style={styles.inputBox}>
                    ...
                    <Text style={styles.inputLabel}>
                        {translations.sleeping.sleepingTime}
                    </Text>
                ...
                <View style={styles.inputBox}>
                    ...
                    <Text style={styles.inputLabel}>
                        {translations.sleeping.wakeTime}
                    </Text>
